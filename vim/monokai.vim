...
let s:brown       = { "gui": "#64645e", "cterm": "144" }
...
let s:red         = { "gui": "#e73c50", "cterm": "161" }
...
call s:h("CursorLineNr",  { "fg": s:yellow,     "bg": s:black })
...
call s:h("Comment",       { "fg": s:brown, "format": "italic" })
...
call s:h("jsFunctionKey",       { "fg": s:aqua })
